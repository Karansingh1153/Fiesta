                        ...
                        <div class="container">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                                    <li class="nav-item">
                                        <a class="nav-link" data-name="Home" href="organizer.php">Home</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-name="Gallery" href="#">Gallery</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-name="Services" href="#">Services</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-name="Plans&Pricing" href="#">Plans&Pricing</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-name="AboutUs" href="#">AboutUs</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-name="Contact" href="#">Contact</a>
                                    </li>
                                    <li class="nav-item">
