...
?>
                    ...
                    <tbody class="text-center">
                        ...
                        while ($eventRow = mysqli_fetch_assoc($eventResult)) {
                            ...
                            echo "<td>
                                ...
                                <button type='submit' style='background-color:#3ae374; border:2px solid #3ae374; color:#fff;'  class='btn-v' name='update'>Update</button>
                                </form>
                            </td>";
                            echo "<td>
                            ...
                            echo "<td>
                                    <form method='POST' style='box-shadow: none;' action='generateWord.php?id=" . $eventRow['id'] . "&&festName=" . $festName . "'>
                                    <button type='submit' class='btn-v' style='background-color:#17c0eb; border:2px solid #17c0eb; color:#fff;' name='delete'>Generate Word</button>
                                    </form>
                                </td>";
                            echo "</tr>";
                        }
    ...
    ?>
    <script>
        window.location.href = "http://localhost/organizer/selectService.php";
    </script>
<?php
}
?>
